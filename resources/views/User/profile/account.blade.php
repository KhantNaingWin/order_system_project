                ...
                <div class="card">
                    <div class="card-body">
                       <div class="row">
                        ...
                        <hr class="bg-dark">
                            <form action="{{ route('user#acountchangepage',Auth::user()->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-3 offset-2">
                                     @if (Auth::user()->image == null)
                                         <img src="{{ asset('image/user_image.webp') }}" class=" img-thumbnail shadow-sm">
                                     @else
                                    ...
                                    <div class="col-4 offset-1">
                                        <div class="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input  name="role" type="text" class="form-control" aria-required="true" value="{{ old('role',Auth::user()->role) }}" aria-invalid="false" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
