                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-5 offset-2">
                                    <h3 class="my-4"> <i
                                            class="fa-regular fa-circle-user mr-2"></i>{{ Auth::user()->name }}</h3>
                                    <h3 class="my-4"><i class="fa-regular fa-envelope mr-2"></i>{{ Auth::user()->email }}
                                    </h3>
                                    <h3 class="my-4"><i class="fa-solid fa-phone mr-2"></i>{{ Auth::user()->phone }}</h3>
                                    <h3 class="my-4"><i
                                            class="fa-regular fa-address-card mr-2"></i>{{ Auth::user()->address }}</h3>
                                    <h3 class="my-4">
