                                        ...
                                        <div class="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="pizzaDescription" class="form-control @error('pizzaDescription') is-invalid @enderror" id=""
                                                    cols="30" rows="10" placeholder="enter pizza description...">{{ old('pizzaDescription', $pizza->description) }}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="pizzaWaitingTime" type="number"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="viewCount" type="number" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="created_at" type="text" class="form-control"
                                                    aria-required="true" value="{{ $pizza->created_at->format('j-F-Y') }}"
                                                    aria-invalid="false" disabled>
                                            </div>
                                        </div>
                                    </div>
